...
function onWindowResize(){alert(document.getElementsByTagName('body')[0].offsetHeight);alert(window.parent.document.getElementsByTagName('iframe')[0].height);window.parent.document.getElementsByTagName('iframe')[0].height=document.getElementsByTagName('body')[0].offsetHeight;}
