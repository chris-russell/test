...
function onWindowResize(){alert(document.getElementsByTagName('body')[0].offsetHeight);alert(parent.document.getElementsByTagName('iframe')[0].height);parent.document.getElementsByTagName('iframe')[0].height=document.getElementsByTagName('body')[0].offsetHeight;}
